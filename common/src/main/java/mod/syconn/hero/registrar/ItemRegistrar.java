...
public class ItemRegistrar {
    ...
    public static final Supplier<Item> MARK_42_HELMET = registerItem("mark_42_helmet", properties -> new ArmorItem(ArmorMaterials.MARK_42, ArmorType.HELMET, properties));
    public static final Supplier<Item> MARK_42_CHESTPLATE = registerItem("mark_42_chestplate", properties -> new ArmorItem(ArmorMaterials.MARK_42, ArmorType.CHESTPLATE, properties));
    public static final Supplier<Item> MARK_42_LEGGINGS = registerItem("mark_42_leggings", properties -> new ArmorItem(ArmorMaterials.MARK_42, ArmorType.LEGGINGS, properties));
    public static final Supplier<Item> MARK_42_BOOTS = registerItem("mark_42_boots", properties -> new ArmorItem(ArmorMaterials.MARK_42, ArmorType.BOOTS, properties));
