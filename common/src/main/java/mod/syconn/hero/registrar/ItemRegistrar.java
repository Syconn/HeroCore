...
public class ItemRegistrar {
    ...
    // TODO MAKE IT WORK WITH CUSTOM MATERIALS
    public static final Supplier<Item> MARK_42_HELMET = registerItem("mark_42_helmet", () -> new ArmorItem(ArmorMaterials.IRON, ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(15))));
    public static final Supplier<Item> MARK_42_CHESTPLATE = registerItem("mark_42_chestplate", () -> new ArmorItem(ArmorMaterials.IRON, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(15))));
    public static final Supplier<Item> MARK_42_LEGGINGS = registerItem("mark_42_leggings", () -> new ArmorItem(ArmorMaterials.IRON, ArmorItem.Type.LEGGINGS, new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(15))));
    public static final Supplier<Item> MARK_42_BOOTS = registerItem("mark_42_boots", () -> new ArmorItem(ArmorMaterials.IRON, ArmorItem.Type.BOOTS, new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(15))));
